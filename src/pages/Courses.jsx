...
export default function Courses({ courses = [], assignments = [], onStatusChange }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-xs text-dark-muted">Browse your academic subjects and course-specific tasks.</p>
      </div>
